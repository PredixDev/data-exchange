...
public abstract class BaseTest
{
    ...
    AssetPutDataHandlerImpl     assetPutFieldDataHandler;

    @InjectMocks
    @Autowired
    @Qualifier("metaDataPutFieldDataService")
            ...
            throws UnsupportedEncodingException, IOException, HttpException
    {
        ...
        PutFieldDataResult result = this.metaDataPutFieldDataService.putData(request, modelLookupMap, headers);
