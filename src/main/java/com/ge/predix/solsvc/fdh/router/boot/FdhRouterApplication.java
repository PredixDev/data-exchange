...
@ImportResource(
{
        ...
        "classpath*:META-INF/spring/ext-util-scan-context.xml", "classpath*:META-INF/spring/fdh-router-cxf-context.xml",
...
public class FdhRouterApplication extends PredixSpringBootInitializer
{
    ...
    private static final Logger log = LoggerFactory.getLogger(FdhRouterApplication.class);
